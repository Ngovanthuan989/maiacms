...
<style>
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Thêm mới chi phí sản phẩm</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
    ...
    <div class="container">
        ...
        <form id="form" method="post" action="{{ route('dashboard.cashFlowProduct.addPost') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mt-10">
                          <label>Số tiền</label>
                          <input type="text" name="tien[]" value="" placeholder="" class="form-control dot1">
                        </div>
                      </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mt-10">
                          <label>Số tiền</label>
                          <input type="text" name="tien[]" value="" placeholder="" class="form-control dot2">
                        </div>
                      </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mt-10">
                          <label>Số tiền</label>
                          <input type="text" name="tien[]" value="" placeholder="" class="form-control dot3">
                        </div>
                      </div>
                </div>
              <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group mt-10">
                        ...
                        <input type="text" name="money_back" value="" placeholder="" class="form-control money_back">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group mt-10">
                        <label>Chi phí ads</label>
                        <input type="text" name="ads_costs" value="" placeholder="" class="form-control ads_costs">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group mt-10">
                        ...
                        <input type="text" name="other_costs" value="" placeholder="" class="form-control other_costs">
                      </div>
                    </div>
                  </div>
            </div>
