...
<style>
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Cập nhập chi phí vận hành</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
    ...
    <div class="container">
        ...
        <form id="form" method="post" action="{{ route('dashboard.operatingCosts.update') }}" enctype="multipart/form-data">
        @csrf
        <div class="wizard wizard-4" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="true">
            <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
        <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Cập nhập chi phí vận hành của Maia</h3>
            </div>
            <input type="hidden" name="id" value="{{$get_operating_costs->id}}" >
            <!-- /.card-header -->
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group mt-10">
                        ...
                        <input type="text" name="name" id="" value="{{$get_operating_costs->name}}" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mt-10">
                          <label>Số tiền chi</label>
                          <input type="text" name="cost" value="{{$get_operating_costs->cost}}" placeholder="" class="form-control cost">
                        </div>
                      </div>
                </div>
              <!-- /.row -->
